...
namespace U8_Sale
{
    public partial class frmSalePlans : UserControl
    {
        ...
        {
            string StrSQL1 = "SELECT * FROM SL_P_SalePlan_Month ORDER BY iMonth ASC";
...
ON s12.cSalePlanId = s11.cSalePlanId ")).Tables[0];
        ...
        private void frmSalePlans_Load(object sender, EventArgs e)
        {
            DataBind();
            ButtonStatus("LoadForm");
        }
